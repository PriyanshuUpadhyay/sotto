...
enum ModelProvider: String, Codable, Hashable, CaseIterable {
    ...
    init(from decoder: Decoder) throws {
        ...
        // Unknown raw values (e.g. a previously-selected cloud provider like
        // "Groq" persisted before cloud transcription was removed) fall back
        // to the default on-device provider rather than throwing.
        self = ModelProvider(rawValue: raw) ?? .whisper
    }
}
