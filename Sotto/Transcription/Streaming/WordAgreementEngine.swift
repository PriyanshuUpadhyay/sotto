...
struct AgreementResult {
    ...
    // The not-yet-confirmed tail from this pass alone (fullText minus the
    // historical confirmed prefix) — what a caller needs to reuse this
    // pass's decode as a final/remaining result instead of re-decoding.
