...
enum SottoEngineError: Error, Identifiable {
    case modelLoadFailed
    case transcriptionFailed
    case whisperCoreFailed
    case unzipFailed
    case unsupportedFluidAudioModel(String)
    case unknownError

    var id: String { UUID().uuidString }
}

extension SottoEngineError: LocalizedError {
    var errorDescription: String? {
        ...
        case .unsupportedFluidAudioModel(let modelName):
            return "Unsupported FluidAudio model id: \(modelName)."
        case .unknownError:
    ...
    var recoverySuggestion: String? {
        ...
        case .unsupportedFluidAudioModel:
            return "Select a supported Parakeet TDT or Unified model, or update the FluidAudio integration before using this model."
        case .unknownError:
...
typealias WhisperStateError = SottoEngineError
