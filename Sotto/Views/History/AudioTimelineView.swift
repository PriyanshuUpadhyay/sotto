    ...
    private var playPauseButton: some View {
        Button(action: onPlayPause) {
            Circle()
                ...
                .overlay(
                    Circle()
                        .stroke(Brand.tint.opacity(0.32), lineWidth: 0.5)
                )
                .overlay(
            ...
            ForEach(0..<samples.count, id: \.self) { i in
                ...
                Capsule()
                    .fill(
                        LinearGradient(
                            colors: [
                                isPlayed ? Brand.tint : Color.primary.opacity(0.30),
                                isPlayed ? Brand.tint.opacity(0.7) : Color.primary.opacity(0.18)
                            ],
                            startPoint: .bottom,
                            endPoint: .top
                        )
