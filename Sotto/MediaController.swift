...
final class MediaController: ObservableObject {
    ...
    func muteSystemAudio() async -> Bool {
        ...
        // When pause-media is enabled, defer to it — pause and mute together looked
        // like "mute instead of pause" because the pause is invisible while output
        // is also silenced.
        if PlaybackController.shared.isPauseMediaEnabled { return false }
