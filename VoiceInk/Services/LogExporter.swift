...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: OSLogSubsystems.app, category: "LogExporter")
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Sotto Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Sotto_Logs_\(timestamp).log"
