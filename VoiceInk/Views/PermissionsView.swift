        ...
        ScrollView {
            VStack(spacing: 32) {
                ...
                CompactHeroSection(
                    ...
                    description: "Sotto requires the following permissions to function properly"
                )
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use Sotto anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Sotto to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Sotto to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "Sotto uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Sotto to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "Sotto captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
